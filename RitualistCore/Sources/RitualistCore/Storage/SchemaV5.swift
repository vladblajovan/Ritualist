...
extension SchemaV5.UserProfileModel {
    ...
    public func toEntity() -> UserProfile {
        ...
        // Convert V5 timezone fields to V9 UserProfile three-timezone model
        ...
        return UserProfile(
            ...
            timezoneChangeHistory: [],  // No history in V5
            createdAt: createdAt,
            updatedAt: updatedAt
        )
    }
    ...
    public static func fromEntity(_ profile: UserProfile) -> UserProfileModelV5 {
        // Convert V9 three-timezone model back to V5 format
        let homeTimezoneV5 = profile.homeTimezoneIdentifier
        let displayModeV5 = profile.displayTimezoneMode.toLegacyString()
        ...
        return SchemaV5.UserProfileModel(
            ...
            homeTimezone: homeTimezoneV5,
            displayTimezoneMode: displayModeV5,
