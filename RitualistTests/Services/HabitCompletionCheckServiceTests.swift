...
/// This is NOT a mock in the traditional sense - it's a test implementation
/// that provides real behavior with configurable values
final class MockTimezoneService: TimezoneService {
    private let displayTimezone: TimeZone
    private let shouldThrowError: Bool

    init(displayTimezone: TimeZone = .current, shouldThrowError: Bool = false) {
