...
public protocol HabitCompletionServiceProtocol: RitualistCore.HabitCompletionService {
    ...
    /// - For timesPerWeek: returns true if weekly target is met by that date
...
public final class DefaultHabitCompletionService: HabitCompletionServiceProtocol {
