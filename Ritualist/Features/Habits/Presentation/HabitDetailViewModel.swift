...
public final class HabitDetailViewModel {
    ...
    let getEarliestLogDate: GetEarliestLogDateUseCase
    let validateHabitUniqueness: ValidateHabitUniquenessUseCase
    let getActiveCategories: GetActiveCategoriesUseCase
    let permissionCoordinator: PermissionCoordinatorProtocol
    ...
    @ObservationIgnored var displayTimezone: TimeZone = .current
    ...
    public var categoriesError: Error?
    ...
    // Validation state
    public var isDuplicateHabit = false
    public var isValidatingDuplicate = false
    public var duplicateValidationFailed = false

    // Start date validation state (for edit mode)
    public var earliestLogDate: Date?
    public var isLoadingEarliestLogDate = false
    public var earliestLogDateLoadFailed = false
