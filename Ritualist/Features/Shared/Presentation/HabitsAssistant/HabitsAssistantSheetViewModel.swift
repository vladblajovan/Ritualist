...
public final class HabitsAssistantSheetViewModel {
    ...
    let createHabitFromSuggestionUseCase: CreateHabitFromSuggestionUseCase
    let removeHabitFromSuggestionUseCase: RemoveHabitFromSuggestionUseCase
    let checkHabitCreationLimit: CheckHabitCreationLimitUseCase
    private let userService: UserService
    let trackUserAction: TrackUserActionUseCase?
    ...
    public var addedSuggestionIds: Set<String> = []
    public var suggestionToHabitMappings: [String: UUID] = [:]
    ...
    public var canCreateMoreHabits = false
